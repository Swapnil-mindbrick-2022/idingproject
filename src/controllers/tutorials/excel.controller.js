...
const Up = db.Up
const Jharkhand = db.Jharkhand
const Bihar = db.Bihar
const Rajasthan =db.Rajasthan
const IVRS = db.ivrs;
const Uploadhistory = db.uploadhistory;
const Tripura= db.Tripura
    ...
    for (let file of req.files) {
      try{
        ...
        for (let i = 0; i < ivrsdata; i++) {
         ...
         console.log(data9.length)
         console.log(data10.length)
         uploadResults= await Tripura.bulkCreate(data,{
          fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
          updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data2,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data3,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data4,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data5,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data6,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data7,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data8,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data9,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Tripura.bulkCreate(data10,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
    ...
    for (let file of req.files) {
      try{
        ...
        for (let i = 0; i < ivrsdata; i++) {
         ...
         console.log(data9.length)
         console.log(data10.length)
         uploadResults= await Jharkhand.bulkCreate(data,{
          fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
          updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data2,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data3,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data4,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data5,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data6,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data7,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data8,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data9,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Jharkhand.bulkCreate(data10,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
    ...
    for (let file of req.files) {
      try{
        ...
        for (let i = 0; i < ivrsdata; i++) {
         ...
         console.log(data9.length)
         console.log(data10.length)
         uploadResults= await Bihar.bulkCreate(data,{
          fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
          updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data2,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data3,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data4,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data5,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data6,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data7,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data8,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data9,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Bihar.bulkCreate(data10,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
    ...
    for (let file of req.files) {
      try{
        ...
        for (let i = 0; i < ivrsdata; i++) {
         ...
         console.log(data9.length)
         console.log(data10.length)
         uploadResults= await Rajasthan.bulkCreate(data,{
          fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
          updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data2,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data3,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data4,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data5,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data6,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data7,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data8,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data9,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
          ...
          uploadResults= await Rajasthan.bulkCreate(data10,{
            fields:["id","GENDER", "mobile",'Name', 'Pincode', 'state', 'AC_Number','AC_Name','AGE'],
            updateOnDuplicate: ["mobile"] ,
